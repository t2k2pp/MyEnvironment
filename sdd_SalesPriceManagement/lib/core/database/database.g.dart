...
class $ProductsTable extends Products with TableInfo<$ProductsTable, Product> {
  ...
  @override
  List<GeneratedColumn> get $columns => [id, categoryId, name, memo, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Product extends DataClass implements Insertable<Product> {
  ...
  @override
  int get hashCode => Object.hash(id, categoryId, name, memo, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Product &&
...
class $PriceRecordsTable extends PriceRecords
    with TableInfo<$PriceRecordsTable, PriceRecord> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $PriceRecordsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'price_records';
  @override
  VerificationContext validateIntegrity(
    Insertable<PriceRecord> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  PriceRecord map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return PriceRecord(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
  ...
  @override
  $PriceRecordsTable createAlias(String alias) {
    return $PriceRecordsTable(attachedDatabase, alias);
  }
}

class PriceRecord extends DataClass implements Insertable<PriceRecord> {
  final int id;
  final int productId;
  final int storeId;
  final int price;
  ...
  PriceRecordsCompanion toCompanion(bool nullToAbsent) {
    return PriceRecordsCompanion(
      id: Value(id),
  ...
  PriceRecord copyWithCompanion(PriceRecordsCompanion data) {
    return PriceRecord(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('PriceRecord(')
          ..write('id: $id, ')
  ...
  @override
  int get hashCode =>
      Object.hash(id, productId, storeId, price, purchaseDate, memo, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class PriceRecordsCompanion extends UpdateCompanion<PriceRecord> {
  final Value<int> id;
  ...
  PriceRecordsCompanion.insert({
    ...
    this.createdAt = const Value.absent(),
       ...
       price = Value(price),
       purchaseDate = Value(purchaseDate);
  static Insertable<PriceRecord> custom({
    Expression<int>? id,
  ...
  PriceRecordsCompanion copyWith({
    Value<int>? id,
    Value<int>? productId,
    Value<int>? storeId,
    Value<int>? price,
  ...
  @override
  String toString() {
    return (StringBuffer('PriceRecordsCompanion(')
          ..write('id: $id, ')
          ..write('productId: $productId, ')
          ..write('storeId: $storeId, ')
          ..write('price: $price, ')
...
class $ProductImagesTable extends ProductImages
  ...
  @override
  List<GeneratedColumn> get $columns => [id, productId, imagePath, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class ProductImage extends DataClass implements Insertable<ProductImage> {
  ...
  @override
  int get hashCode => Object.hash(id, productId, imagePath, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $PriceRecordsTable priceRecords = $PriceRecordsTable(this);
...
final class $$ProductsTableReferences
  ...
  static MultiTypedResultKey<$PriceRecordsTable, List<PriceRecord>>
  _priceRecordsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.priceRecords,
    aliasName: $_aliasNameGenerator(db.products.id, db.priceRecords.productId),
  );

  $$PriceRecordsTableProcessedTableManager get priceRecordsRefs {
    final manager = $$PriceRecordsTableTableManager(
      $_db,
      $_db.priceRecords,
    ).filter((f) => f.productId.id.sqlEquals($_itemColumn<int>('id')!));

    final cache = $_typedResult.readTableOrNull(_priceRecordsRefsTable($_db));
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  }
...
class $$ProductsTableFilterComposer
  ...
  Expression<bool> priceRecordsRefs(
    Expression<bool> Function($$PriceRecordsTableFilterComposer f) f,
  ) {
    final $$PriceRecordsTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.priceRecords,
      ...
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$PriceRecordsTableFilterComposer(
            $db: $db,
            $table: $db.priceRecords,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
            $removeJoinBuilderFromRootComposer:
                $removeJoinBuilderFromRootComposer,
...
class $$ProductsTableAnnotationComposer
  ...
  Expression<T> priceRecordsRefs<T extends Object>(
    Expression<T> Function($$PriceRecordsTableAnnotationComposer a) f,
  ) {
    final $$PriceRecordsTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.priceRecords,
      getReferencedColumn: (t) => t.productId,
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$PriceRecordsTableAnnotationComposer(
            $db: $db,
            $table: $db.priceRecords,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
    ...
    : super(
        TableManagerState(
          ...
          prefetchHooksCallback:
              ({
                categoryId = false,
                priceRecordsRefs = false,
                productImagesRefs = false,
              }) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
                    if (priceRecordsRefs) db.priceRecords,
...
final class $$StoresTableReferences
  ...
  _priceRecordsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.priceRecords,
    aliasName: $_aliasNameGenerator(db.stores.id, db.priceRecords.storeId),
  );
...
class $$StoresTableTableManager
    extends
        RootTableManager<
          ...
          Store,
          PrefetchHooks Function({bool priceRecordsRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({priceRecordsRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [if (priceRecordsRefs) db.priceRecords],
              addJoins: null,
              getPrefetchedDataCallback: (items) async {
                return [
                  if (priceRecordsRefs)
                    await $_getPrefetchedData<Store, $StoresTable, PriceRecord>(
                      currentTable: table,
...
typedef $$StoresTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool priceRecordsRefs})
    >;
typedef $$PriceRecordsTableCreateCompanionBuilder =
    PriceRecordsCompanion Function({
      Value<int> id,
      required int productId,
      required int storeId,
      required int price,
...
typedef $$PriceRecordsTableUpdateCompanionBuilder =
    PriceRecordsCompanion Function({
      Value<int> id,
      Value<int> productId,
      Value<int> storeId,
...
final class $$PriceRecordsTableReferences
    extends BaseReferences<_$AppDatabase, $PriceRecordsTable, PriceRecord> {
  $$PriceRecordsTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $ProductsTable _productIdTable(_$AppDatabase db) =>
      db.products.createAlias(
        $_aliasNameGenerator(db.priceRecords.productId, db.products.id),
      );
  ...
  static $StoresTable _storeIdTable(_$AppDatabase db) => db.stores.createAlias(
    $_aliasNameGenerator(db.priceRecords.storeId, db.stores.id),
  );
...
class $$PriceRecordsTableFilterComposer
    extends Composer<_$AppDatabase, $PriceRecordsTable> {
  $$PriceRecordsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$PriceRecordsTableOrderingComposer
    extends Composer<_$AppDatabase, $PriceRecordsTable> {
  $$PriceRecordsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$PriceRecordsTableAnnotationComposer
    extends Composer<_$AppDatabase, $PriceRecordsTable> {
  $$PriceRecordsTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$PriceRecordsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $PriceRecordsTable,
          ...
          $$PriceRecordsTableOrderingComposer,
          $$PriceRecordsTableAnnotationComposer,
          $$PriceRecordsTableCreateCompanionBuilder,
          $$PriceRecordsTableUpdateCompanionBuilder,
          (PriceRecord, $$PriceRecordsTableReferences),
          PriceRecord,
          PrefetchHooks Function({bool productId, bool storeId})
        > {
  $$PriceRecordsTableTableManager(_$AppDatabase db, $PriceRecordsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$PriceRecordsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$PriceRecordsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$PriceRecordsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$PriceRecordsTableReferences(db, table, e),
                ),
              )
              .toList(),
                    ...
                    if (productId) {
                      state =
                          state.withJoin(
                                ...
                                referencedTable: $$PriceRecordsTableReferences
                                    ._productIdTable(db),
                                referencedColumn: $$PriceRecordsTableReferences
                                    ._productIdTable(db)
                                    .id,
                              )
                              as T;
...
typedef $$PriceRecordsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $PriceRecordsTable,
      PriceRecord,
...
class $AppDatabaseManager {
  ...
  $$PriceRecordsTableTableManager get priceRecords =>
      $$PriceRecordsTableTableManager(_db, _db.priceRecords);
